> [!NOTE]  
> This project is only a simple **chessboard interface** and contains **no logic** of the game, hence it requires [Chess-API](https://github.com/YoYo178/chess-api) to work.
